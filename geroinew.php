...
use Models\HeroFactory;

require __DIR__ . '/Vendor/autoload.php';

$weight_weapon = new weight_weapons;

$warrior = HeroFactory::createHero(300, 200, 'bow');
...
echo "Hp: " . $warrior->getHp() . PHP_EOL;
echo "Guns: " . $warrior->getGuns() . PHP_EOL;
echo "Durability: " . $warrior->getDurability() . PHP_EOL;
